...
import type { RecommendationResult } from "@/server/recommendations";

import type { useRecommendationsController } from "./use-recommendations-controller";

const CARD_EXIT_DISTANCE_PX = 220;
const DRAG_TAP_SUPPRESSION_MS = 250;

export type RecommendationsController = ReturnType<
	typeof useRecommendationsController
>;
...
function RecommendationCard({
	...
	dragX: RecommendationsController["dragX"];
	dragXOpacity: RecommendationsController["dragXOpacity"];
	dragXRotate: RecommendationsController["dragXRotate"];
	exitDirection: -1 | 0 | 1;
	isWorking: boolean;
	onDecline: () => void;
	onLike: () => void;
...
export function RecommendationViewport({
	controller,
}: {
	controller: RecommendationsController;
}) {
	const recommendation = controller.currentRecommendation;
