...
function RecommendationsAllEmptyState() {
	return (
		<RecommendationsAllShell>
			<RecommendationsAllHeader />
			<RecommendationsAllHeading />
...
export default function RecommendationsAllPage({
	...
	const hasNewRecommendations = data.newRecommendations.length > 0;
	...
	return (
		<RecommendationsAllShell>
			...
			{hasNewRecommendations ? (
				<NewRecommendationsCard count={data.newRecommendations.length} />
			) : null}
